  ...
  return (
    <form action="#">
      <div className="relative mx-auto w-full sm:w-full lg:w-[80%] group">
        ...
        <input
          className="text-[#9E9E9E80] focus:text-white hover:border-white bg-[rgba(42,29,76,0.2)] h-12 w-[80%] lg:w-full border border-[#9E9E9E80] rounded-2xl mt-4 text-start pr-12 pl-12"
